 ...
 * https://en.wikipedia.org/wiki/Chain-of-responsibility_pattern#Java_example
 *
 * Below is an example of this pattern in Java. In this example we have different roles, each having a fixed purchasing limit and a successor.
 * Every time a user in a role receives a purchase request that exceeds his or her limit, the request is passed to his or her successor.
