 ...
 * A much simpler example in "modern Java" (Java 8 and later), using lambdas, may be found here: https://en.wikibooks.org/wiki/Computer_Science_Design_Patterns/Strategy
 *
 */
